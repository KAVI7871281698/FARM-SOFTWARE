...
def create_scout_on_critical_health(sender, instance, created, **kwargs):
    ...
    is_mapped = instance.plot.status in ['Mapped', 'mapped'] or bool(instance.plot.boundaries)
...
class ScoutResult(models.Model):
    ...
    plant_population = models.CharField(max_length=50, blank=True, null=True)
    ...
    weed = models.CharField(max_length=50, blank=True, null=True)
    nutrition = models.CharField(max_length=50, blank=True, null=True)
    soil_related = models.CharField(max_length=50, blank=True, null=True)
    farmer_neg = models.CharField(max_length=50, blank=True, null=True)

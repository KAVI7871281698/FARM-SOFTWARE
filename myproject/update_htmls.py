...
# divisions.html
insert_import_form(r"d:\Own Apps\Clients docs\Farm Signals\myproject\myapp\templates\divisions.html", "import_divisions", "add_division")

# sections.html
insert_import_form(r"d:\Own Apps\Clients docs\Farm Signals\myproject\myapp\templates\sections.html", "import_sections", "add_section")

# villages.html
insert_import_form(r"d:\Own Apps\Clients docs\Farm Signals\myproject\myapp\templates\villages.html", "import_villages", "add_village")

# users.html (farmers)
# Wait, for users.html the button might be 'add_farmer' or similar. Let me check users.html first.
